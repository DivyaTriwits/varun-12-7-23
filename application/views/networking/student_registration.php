...
<head>
  ...
  <meta charset="utf-8">
	...
	<meta name="description" content="The Global Scholarship - A Scholarship Search Engine">
	<meta name="author" content="THE GLOBAL SCHOLARSHIP">
	<meta name="keywords" content="Scholarships, Alerts, Education, Private scholarships, opportunities, scholarship alerts, Scholarship, Application, Amount, Price, Gender based scholarships, merit based scholarships, talent based scholarships, need based scholarships, new scholarships, free scholarships">
	<!-- Favicon -->
...
<body class="horizontalmenu" >
						...
						<div class="card" >
							<div class="">
								...
								<div class="card-body mt-2 mb-2">
									...
									<form id="studentRegistrationForm" method="post" action="<?php echo base_url()?>promotional-student-registration">
										...
										<div class="form-group text-left">
											...
											<input class="form-control rounded-11" name="sid" id="sid"  value="<?php echo $this->input->get('sid')?>" type="hidden" autocomplete="off" required>
										...
										<div class="form-group text-left">
											...
											class="form-control rounded-11" name="email" id="email" placeholder="Student Email " type="email" autocomplete="off" required>
										</div>
										...
										<div class="form-group text-left">
											...
											<select class="form-control select2" name="state"  id="state" autocomplete="off" >
												<option label="Choose one"></option>
												<?php if($states->num_rows()>0){ foreach(array_reverse($states->result()) as $row){?>
										...
										<div class="row">
											...
											<div class="col-12 mt-3">
												<input type="submit" class="btn btn-primary rounded-11 btn-block" value="Get Alerts">
											</div>
	...
	<?php if($this->session->flashdata('account-error')){?>		
		<Script>
			swal({
				title: 'Alas!',
			...
			$('#studentRegistrationForm').bootstrapValidator({
				...
				fields: {
					...
					mobile_number: {
						validators: {
							notEmpty: {
								message: 'Student mobile number is required and cannot be empty'
							},
							stringLength: {
								min: 10,
								max: 10,
								message: 'Student mobile number must have 10 digits'
							},
							regexp: {
								regexp: /[0-9]/,
								message: ' <br >Student mobile number can only consist of digits'
							}
