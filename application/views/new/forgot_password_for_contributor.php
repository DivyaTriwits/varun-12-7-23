        ...
        <div class="login-form-area">
          <form method="post" class="needs-validation" novalidate>
            ...
            <div class="col-md-12 mb-3">
              ...
              <p><button class="btn btn-default btn-primary" type="submit">Recover Your Account</button></p>
            </div>
            <!--<p style="text-align: center;"><a href="forgot_password.php"> <b>FORGOT PASSWORD?</b></a></p> -->
            <p style="text-align: center; margin-top:-12px;">Registered?  <a href="<?php echo base_url('login');?>"> <b>LOGIN</b></a></p>
          </form>
        </div><!--/.login-form-area-->
      </div><!--/.col-lg-4-->
    </div><!--/.row-->
