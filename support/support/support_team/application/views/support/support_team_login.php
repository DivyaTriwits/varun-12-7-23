						...
						<div class="card" >
							<div class="">
								...
								<div class="text-center">
									...
									<form id="supportLoginForm" method="post" action="<?php echo base_url()?>verify-support-team-login">
										<h5 class="text-center mb-5 mt-2">Sign In</h5>
...
<Script>
	swal({
		title: 'Account!',
		text: 'No acoount found with this email!',
		type: 'error',
		timer: 3000,
        showConfirmButton: false
	});
