...
<!-- Mirrored from www.spruko.com/demo/dashpro/Dashpro/HTML-LTR/Horizontal-light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Jan 2021 09:48:59 GMT -->
<head>
...
<body class="horizontalmenu">
	...
	<div id="global-loader">
		<img height="55px !important" src="<?php echo base_url()?>assets/img/brand/sc logo.png" class="loader-img" alt="Loader">
	</div>
	<!-- End Loader -->
	...
	<div class="page">
			...
			<div class="container">
				<div class="main-header-left">
					...
					<a class="main-logo" href="<?php echo base_url()?>">
						<img height="55px !important" src="<?php echo base_url()?>assets/img/brand/sc logo.png" class="header-brand-img desktop-logo" alt="logo">
						<img src="<?php echo base_url()?>assets/img/brand/sc logo.png" class="header-brand-img desktop-logo theme-logo" alt="logo">
					</a>
				</div>
				<div class="main-header-center">
					<div class="responsive-logo">
						<a  href="<?php echo base_url()?>"><img height="55px !important" src="<?php echo base_url()?>assets/img/brand/sc logo.png" class="mobile-logo" alt="logo"></a>
						<a href="<?php echo base_url()?>"><img src="<?php echo base_url()?>assets/img/brand/sc logo.png" class="mobile-logo-dark" alt="logo"></a>
					</div>
					...
					<div class="dropdown main-header-notification">
						...
						<div class="dropdown main-profile-menu">
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item border-top" href="<?php echo base_url()?>support-team-profile-page">
								...
								<a class="dropdown-item" href="<?php echo base_url()?>support-team-logout">
		...
		<!-- Horizonatal menu-->
		<div class="main-navbar hor-menu sticky" style="background-color: #ff7f45 !important">
			<div class="container">
				<ul class="nav">

					<?php if(($this->uri->segment(1) == 'personal_details') ||($this->uri->segment(1) == 'academic_details') ||($this->uri->segment(1) == 'family_details') ||($this->uri->segment(1) == 'bank_address_details') ||($this->uri->segment(1) == 'extracurricular_details') ||($this->uri->segment(1) == 'document_uploads')) {?>
						<li class="nav-item">
							<a class="nav-link font-weight-semibold" href="<?php echo base_url('personal_details')?>"><i class="mdi mdi-account"></i>Personal Details</a>
						</li>
						<li class="nav-item">
							<a class="nav-link font-weight-semibold" href="<?php echo base_url('academic_details')?>"><i class="zmdi zmdi-graduation-cap"></i>Academic Details</a>
						</li>
						<li class="nav-item">
							<a class="nav-link font-weight-semibold" href="<?php echo base_url('family_details')?>"><i class="mdi mdi-account-multiple"></i>Family Details</a>
						</li>
						<li class="nav-item">
							<a class="nav-link font-weight-semibold" href="<?php echo base_url('extracurricular_details')?>"><i class="fe fe-grid"></i>Extracurricular
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link font-weight-semibold" href="<?php echo base_url('bank_address_details')?>"><i class="mdi mdi-bank"></i>Bank & Address
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link font-weight-semibold" href="<?php echo base_url('document_uploads')?>"><i class="fe fe-grid"></i>Documents
							</a>
						</li>
					<?php } else {?>
						<li class="nav-item">
							<a class="nav-link with-sub font-weight-semibold" href="#"><i class="fe fe-home"></i>Dashboard</a>
