...
<body class="horizontalmenu" >
	...
	<div class="page ">
		...
		<div class="page main-signin-wrapper">
			...
			<!-- Row -->
			<div class="row signpages  justify-content-center text-center sign-2" style="width:60% !important;">
									...
									<div class="">
										<div class="card-body mt-2 mb-2">
											<div class="text-center">
												<img align="center" style="max-width: 15%"  src="<?php echo base_url()?>assets/img/brand/sc logo.png" class="reg-logo" alt="logo" >
											</div>
											<div class="clearfix"></div>

											<form id="studentRegistrationForm" method="post" action="<?php echo base_url()?>add-manual-student-details">
												<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group text-left">
													...
													<input class="form-control rounded-11" name="email" id="email" placeholder="" type="email" autocomplete="off" required>
											...
											<div class="col-md-6">
												<div class="form-group text-left">
													...
													<input class="form-control rounded-11" name="password" id="password" placeholder="" type="password" autocomplete="off" required>
												
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group text-left">
													<label class="">Payement Mode</label>
													<select class="form-control rounded-11 select2" name="payement_mode" id="payement_mode">
											...
											<div class="col-md-6">
												<div class="form-group text-left">
													...
													<input class="form-control rounded-11" name="amount" id="amount" placeholder="" type="text" autocomplete="off" required>
												
												</div>
											</div>
												<div class="col-md-6">
												<div class="form-group text-left">
													<label class="">Refferal Code</label>
													<input class="form-control rounded-11" name="referral_code" id="referral_code" placeholder="" type="text" autocomplete="off" required>
											...
											<div class="col-md-6">
												<div class="form-group text-left">
													...
													<select class="form-control rounded-11 select2" name="subscription" id="subscription">
