												...
												<div class="mg-sm-r-20 mg-b-10">
													<div class="main-profile-contact-list">
														<div class="media">
															...
															<div class="media-body"><strong> <span style="color: grey">Scholarship Name : <?php if($scholarshipDetails!=''){echo $scholarshipDetails->scholarship_name;}?></span></strong> 
																<div> 															</div>
														</div>
													</div>
												</div>
											...
											<div class="mg-sm-r-20 mg-b-10">
												<div class="main-profile-contact-list">
													<div class="media">
														...
														<div class="media-body"> <strong> <span style="color: grey">Start Date : <?php if($scholarshipDetails!=''){echo $scholarshipDetails->start_date;}?> </span></strong> 
															<div></div>
														</div>
													</div>
												</div>
											...
											<div class="mg-sm-r-20 mg-b-10">
												<div class="main-profile-contact-list">
													<div class="media">
														...
														<div class="media-body">  <strong> <span style="color: grey">End Date : <?php if($scholarshipDetails!=''){echo $scholarshipDetails->last_date;}?></span></strong> 
															<div> </div>
														</div>
													</div>
												</div>
														...
														<div class="main-profile-social-list">
															<div class="media">
																...
																<?php if($document->num_rows()>0){ foreach($document->result() as $row ){ ?>
																	<a download href="<?php echo base_url()?>attachment_files/institution_scholarship_files/<?php echo $row->file?>"><i class="fe fe-download" style="font-size:20px; margin-right: 10px; "></i> </a>
																<?php } } ?>
