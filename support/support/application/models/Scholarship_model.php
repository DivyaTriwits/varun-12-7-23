		...
		if($this->input->post('scholarship_name'))
		{
		   ...
		   //print_r($this->input->post());exit;
			...
			( 	'scholarship_id'				=>$scholarshipID,
				...
				'additional_heading1'=>$this->input->post('heading1'),
				'additional_description1'=>$this->input->post('description1'),
				'additional_heading2'=>$this->input->post('heading2'),
				'additional_description2'=>$this->input->post('description2'),
				'list_of_benifits'=>$this->input->post('list_of_benifits'),
