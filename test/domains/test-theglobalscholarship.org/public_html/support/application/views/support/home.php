...
<!-- 		<div class="text-wrap">
		...
		<div class="row text-center">
		    <?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),1);
					...
					<div class="card plan-card">
						<div class="card-block">
							<div class="p-3">
								...
								<h6 class="text-uppercase font-weight-semibold text-secondary">Access Authentications</h6>
							</div>
			...
			<?php }?>
			<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),2);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
			<div class="col-lg-4 col-md-6">
			...
			<?php }?>
				<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),3);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
			<div class="col-lg-4 col-md-6">
				<a href="<?php echo base_url('webinar')?>">
					...
					<?php }?>
						<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),4);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
					<div class="col-lg-4 col-md-6">
					...
					<?php }?>
						<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),5);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
					<div class="col-lg-4 col-md-6">
				...
				<a href="<?php echo base_url('state-wise-registered-students')?>">
					<div class="card plan-card">
						<div class="card-block">
							<div class="p-3">
								<h1 class="pt-2"><i class="fe fe-users plan-icon bg-secondary"></i></h1>
								<h6 class="text-uppercase font-weight-semibold text-secondary">State wise registered students</h6>
							</div>
			...
			<?php }?>
						<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),6);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
							<div class="col-lg-4 col-md-6">
					...
					<?php }?>
						<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),7);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
					<div class="col-lg-4 col-md-6">
					...
					<?php }?>
                    	<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),8);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
					<div class="col-lg-4 col-md-6">
						...
						<?php }?>
	<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),9);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
						<div class="col-lg-4 col-md-6">
                  ...
                  <?php }?>
	<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),10);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
						<div class="col-lg-4 col-md-6">
						...
						<?php }?>
							<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),11);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
						<div class="col-lg-4 col-md-6">
					...
					<?php }?>
					<!-- End Row -->
	<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),12);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
					<div class="col-lg-4 col-md-6">
					...
					<?php }?>
						<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),13);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
					<div class="col-lg-4 col-md-6">
					...
					<?php }?>
						<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),14);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
                    <div class="col-lg-4 col-md-6">
			...
			<?php }?>
				<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),15);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==1)){?>
				<div class="col-lg-4 col-md-6">
			...
			<?php }?>
				<?php $access=$this->Support_model->getaccess($this->session->userdata('supportid'),3);
			if($this->session->userdata('role')!='' && ($this->session->userdata('role')=="Admin" || $access==16)){?>
                		<div class="col-lg-4 col-md-6">
