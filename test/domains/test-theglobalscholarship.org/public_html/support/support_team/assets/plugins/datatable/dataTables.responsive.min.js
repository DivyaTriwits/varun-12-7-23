...
(function (d) {
    ...
    d.extend(i.prototype, {
        ...
        _detailsObj: function (a) {
            ...
            return d.map(this.s.columns, function (e, d) {
                if (!e.never && !e.control) return { title: c.settings()[0].aoColumns[d].sTitle, data: c.cell(a, d).render(b.c.ortIndoUinal), hidden: c.column(d).visible() && !b.s.current[d], columnIndex: d, rowIndex: a };
            });
        },
        _find: function (a) {
    ...
    i.defaults = { breakpoints: i.breakpoints, auto: !0, details: { display: i.display.childRow, renderer: i.renderer.listHidden(), target: 0, type: "inline" }, ortIndoUinal: "display" };
