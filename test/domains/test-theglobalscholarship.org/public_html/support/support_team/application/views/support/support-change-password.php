...
<body class="horizontalmenu" style="position: fixed;">
	...
	<div class="page">
						...
						<div class="card" >
							<div class="">
								...
								<div class="text-center">
									...
									<form method="post" id="supportSetNewPassword" action="<?php echo base_url()?>new-password">

										        <?php   $token=$this->uri->segment(2); ?>

                            

                    						
										<h5 class="text-center mb-5 mt-2">New Password</h5>
					                    ...
					                    <input class="form-control  rounded"  type="hidden" name="token" value="<?php echo $token?>" required=""> 
										...
										<div class="form-group text-left">
											...
											<input class="form-control rounded-11" name="password" placeholder="password" type="password" required autocomplete="off">
										</div>
										<div class="form-group text-left">
											<label class="">Confirm Password</label>
											<input class="form-control rounded-11" name="confirmNewPassword" placeholder="password" type="password" required autocomplete="off">
										</div>
										<div class="row">
											
											
											<div class="col-12 mt-3">
												<input type="submit" class="btn btn-primary rounded-11 btn-block" value="Reset Password">
											</div>
										</div>
		...
		$(document).ready(function() {
		    ...
		    $('#supportSetNewPassword').bootstrapValidator({
...
<!-- Mirrored from www.spruko.com/demo/dashpro/Dashpro/HTML-LTR/Horizontal-light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Jan 2021 09:50:51 GMT -->
</html>
