...
<footer class="footer mr-5" id="footer">
    <div id="buttonGroup" class="btn-group selectors" role="group" aria-label="Basic example">
      <?php if($this->uri->segment(1)=='influencer-home'){?>
     <a  href="<?php echo base_url('influencer-requests')?>"type="button" class="btn button-inactive">
       <!-- <button> -->
   ...
   <?php }?>
     ...
     <a  id="account" type="button" class="btn button-inactive" href="<?php echo base_url('influencer-home')?>">
       <!-- <button> -->
        <div class="selector-holder">
     ...
     <a  id="account" type="button" class="btn button-inactive" href="<?php echo base_url('influencer-setting')?>">
       <!-- <button> -->
        <div class="selector-holder">
