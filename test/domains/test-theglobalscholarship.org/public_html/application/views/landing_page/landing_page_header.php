...
<!--      <marquee>
      ...
      <b style="color: black;"><?php echo $worthOfScholarships->worth; ?> Scholarship worth</b>&nbsp;&nbsp;&nbsp;
      <i class="fa fa-bell fa-2x"> </i>           
      <b style="color: black;"><?php echo $notificationCount;?> + Notifications sent</b>
  </marquee> -->
</div>
...
<div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 col-12 text-center">
    <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 col-12 text-center">
        <a href="<?php echo base_url();?>">
            <img src="<?php echo base_url();?>website_assets/sc logo.png" alt="logo" style="max-width:100px">
        </a>
    </div><!--/.logo-menu-wrap-->
</div><!--/.col-lg-12-->
...
<header id="site-header" class="header-area">
    ...
    <div class="mobile-menu">
        <a class="mobile-logo" href="<?php echo base_url();?>">
            <img src="<?php echo base_url();?>website_assets/sc logo.png" alt="logo" style="max-width:80px">
        </a>
    </div>
    </header><!--/.header-area-->