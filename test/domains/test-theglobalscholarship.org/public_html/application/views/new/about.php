      ...
      <div class="row justify-content-md-center">
         <div class="col-lg-12">
            ...
            <p style="line-height:40px ">
               	The Global Scholarship is one-stop solution through which various  Education Funding services  are provided starting from  getting scholarship details  to the Disbursal of various scholarship  Rewards  to students are enabled .
            </p>
            
            <p style="line-height:40px ">
               The Global Scholarship is Online Scholarship Website that envisioned to bridge the gap between the top scholarship providers , and the scholarship seekers  thus , encouraging more students to be in system. we have built solid relationships with colleges and universities across the country , We Help You to Find Investors for Your “Future!”.
            </p>
            <p style="line-height:40px ">
               Our hardworking dedicated team do check recent scholarship news and adds,updates scholarships in our database daily to make students aware of new scholarship opportunities.
            </p>
            <p style="line-height:40px ">
...
<script>
     (adsbygoogle = window.adsbygoogle || []).push({});
            ...
            <div class="responsibilities">
               ...
               <p class="" style="line-height:40px ">
                  Our vision  is to help the student  community  to achieve  prosperity  in all walks of  their life.
               </p>
               <br>
