...
<head>
    ...
    <link href="<?php echo base_url();?>website_assets/assets/css/themify-icons.css" rel="stylesheet">
    <!--======= Bootstrap Main Css =============-->
    <link href="<?php echo base_url();?>website_assets/assets/css/bootstrap.min.css" rel="stylesheet">
    <!--====== Plugins Css ================-->
    <link href="<?php echo base_url();?>website_assets/assets/css/plugins.css" rel="stylesheet">
    <!--====== Custom CSS for themes =======-->
    <link href="<?php echo base_url();?>website_assets/assets/style.css" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/build/css/intlTelInput.css">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.10/css/select2.min.css" rel="stylesheet" />
    <link href="<?php echo base_url();?>website_assets/assets/tags.css" rel="stylesheet" />
    <link href="<?php echo base_url();?>website_assets/assets/css/perfect-scrollbar.css" rel="stylesheet" />
    <link href="<?php echo base_url();?>website_assets/assets/css/tables.css" rel="stylesheet" />
    <link href="<?php echo base_url();?>website_assets/assets/css/amabassador.css" rel="stylesheet" />
    <link href="<?php echo base_url();?>website_assets/assets/css/floating-button.css" rel="stylesheet" />
    <!--[if lt IE 8]>
    <![endif]-->
    <!-- jQuery Latest Version -->
    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/jquery.bootstrapvalidator/0.5.3/css/bootstrapValidator.css"/>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <script src="<?php echo base_url();?>website_assets/assets/js/vendor/modernizr-2.8.3.min.js"></script>
...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center">
    <div   class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center">
        <a align="center" href="<?php echo base_url('tgs-get-alerts');?>">
            <img src="<?php echo base_url();?>website_assets/assets/sc logo.png" alt="logo" style="max-width:180px">
        </a>
    </div><!--/.logo-menu-wrap-->
</div><!--/.col-lg-12-->
...
<header id="site-header" class="header-area">
    ...
    <div class="mobile-menu">
        <a class="mobile-logo" href="<?php echo base_url();?>">
            <img src="<?php echo base_url();?>website_assets/assets/sc logo.png" alt="logo" style="max-width:80px">
        </a>
    </div>
    </header><!--/.header-area-->