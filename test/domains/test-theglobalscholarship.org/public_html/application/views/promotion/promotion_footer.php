  ...
  <!-- PopperJS -->
  <script src="<?php echo base_url();?>website_assets/assets/js/popper.min.js"></script>
  <!-- Bootstrap framework JS -->
  <script src="<?php echo base_url();?>website_assets/assets/js/bootstrap.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.10/js/select2.min.js"></script>
  <!-- All JS plugins included in this file. -->
  <script src="<?php echo base_url();?>website_assets/assets/js/plugins.js"></script>
  <!-- Main JS file that contents all jQuery Plugins activation. -->
  <script src="<?php echo base_url();?>website_assets/assets/js/main.js"></script>
   <script src="<?php echo base_url();?>website_assets/assets/dist/js/custom.min.js"></script>
...
<script src="<?php echo base_url();?>website_assets/assets/build/js/intlTelInput-jquery.js"></script>
<script src="<?php echo base_url();?>website_assets/assets/build/js/utils.js"></script>
